...
export class Act4Scene2 extends StoryScene {
  ...
  protected transitionToNextScene(): void {
    ...
    this.time.delayedCall(500, () => {
      this.scene.start(SCENES.ACT4_SCENE3);
    });
  }
}
