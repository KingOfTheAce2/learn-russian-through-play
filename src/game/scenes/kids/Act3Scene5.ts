...
export class Act3Scene5 extends StoryScene {
  ...
  protected transitionToNextScene(): void {
    ...
    this.time.delayedCall(500, () => {
      this.scene.start(SCENES.ACT3_SCENE6);
    });
  }
}
