...
export class Act5Scene4 extends StoryScene {
  ...
  protected transitionToNextScene(): void {
    ...
    this.time.delayedCall(500, () => {
      this.scene.start(SCENES.ACT5_SCENE5);
    });
  }
}
